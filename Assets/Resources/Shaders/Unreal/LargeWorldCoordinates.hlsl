...
{
	// Explicit operations rather than mul() avoids z-fighting between depth/base passes
	float3 Offset = INVARIANT((Position.xxx * InMatrix.M[0].xyz + Position.yyy * InMatrix.M[1].xyz + Position.zzz * InMatrix.M[2].xyz) + InMatrix.M[3].xyz);
	return MakeLWCVector3(LWCGetTile(InMatrix), Offset);
}
...
{
	FLWCScalar X2 = LWCMultiply(LWCGetX(Lhs), LWCGetX(Rhs));
	FLWCScalar Y2 = LWCMultiply(LWCGetY(Lhs), LWCGetY(Rhs));
	return LWCAdd(X2, Y2);
}
FLWCScalar LWCDot(FLWCVector2 Lhs, float2 Rhs)
{
	FLWCScalar X2 = LWCMultiply(LWCGetX(Lhs), Rhs.x);
	FLWCScalar Y2 = LWCMultiply(LWCGetY(Lhs), Rhs.y);
	return LWCAdd(X2, Y2);
}
...
FLWCScalar LWCDot(FLWCVector3 Lhs, FLWCVector3 Rhs)
{
	FLWCScalar X2 = LWCMultiply(LWCGetX(Lhs), LWCGetX(Rhs));
	FLWCScalar Y2 = LWCMultiply(LWCGetY(Lhs), LWCGetY(Rhs));
	FLWCScalar Z2 = LWCMultiply(LWCGetZ(Lhs), LWCGetZ(Rhs));
...
FLWCScalar LWCDot(FLWCVector3 Lhs, float3 Rhs)
{
	FLWCScalar X2 = LWCMultiply(LWCGetX(Lhs), Rhs.x);
	FLWCScalar Y2 = LWCMultiply(LWCGetY(Lhs), Rhs.y);
	FLWCScalar Z2 = LWCMultiply(LWCGetZ(Lhs), Rhs.z);
	return LWCAdd(LWCAdd(X2, Y2), Z2);
}
...
FLWCScalar LWCDot(FLWCVector4 Lhs, FLWCVector4 Rhs)
{
	...
	FLWCScalar Y2 = LWCMultiply(LWCGetY(Lhs), LWCGetY(Rhs));
	FLWCScalar Z2 = LWCMultiply(LWCGetZ(Lhs), LWCGetZ(Rhs));
	FLWCScalar W2 = LWCMultiply(LWCGetW(Lhs), LWCGetW(Rhs));
...
FLWCScalar LWCDot(FLWCVector4 Lhs, float4 Rhs)
{
	...
	FLWCScalar Y2 = LWCMultiply(LWCGetY(Lhs), Rhs.y);
	FLWCScalar Z2 = LWCMultiply(LWCGetZ(Lhs), Rhs.z);
	FLWCScalar W2 = LWCMultiply(LWCGetW(Lhs), Rhs.w);
	return LWCAdd(LWCAdd(LWCAdd(X2, Y2), Z2), W2);
}
...
// 'LWC_HACK_TO_ZERO' is a big hammer to work around some internal compiler errors....using this will break the functionality of the shader, but can unbrick testing of other shaders
