...
//public class BRG_Example: MonoSingleton<BRG_Example>
//{
...
//        get
//        {
//            if (ChunkManager.Instance.IsNotNull() && ChunkManager.Instance.MapChunks.IsNotNull())
//            {
//                return ChunkManager.Instance.MapChunks.Count * ChunkManager.Instance.chunkWidth * ChunkManager.Instance.chunkHeight;
//            }
//            return 0;
//        }
//    }
...
//        {
//            matrices[i] = Matrix4x4.Translate(UnityEngine.Random.onUnitSphere * _radius);
//        }
...
//    {
//        _instancesCount = (uint)numVoxels;
//        // Create the buffer that holds our instance data
//        var bufferCountForInstances = BufferCountForInstances(BytesPerInstance, (int)_instancesCount, ExtraBytes);
...
//        // Create transform matrices for our three example instances
//        matrices = new float4x4[_instancesCount];
//        int num = 0;
//        foreach (var chunk in ChunkManager.Instance.MapChunks.Values)
//        {
//            for (int i = 0; i < ChunkManager.Instance.chunkWidth; i++)
//            {
//                for (int j = 0; j < ChunkManager.Instance.chunkHeight; j++)
//                {
//                    Vector3 pos = chunk.leftDownPos;
//                    pos.x += ChunkManager.Instance.brickLengthX * (i - 0.5f);
//                    pos.y += ChunkManager.Instance.brickLengthY * chunk.altitudes[i, j];
//                    pos.z += ChunkManager.Instance.brickLengthZ * (j - 0.5f);
//                    matrices[num] = Matrix4x4.TRS(pos, Quaternion.identity, Vector3.one * 50);
//                    num++;
//                }
//            }
//        }
...
//        // 获取摄像机的视锥体平面
//        Plane[] frustumPlanes = GeometryUtility.CalculateFrustumPlanes(Main.MainCamera);

//        for (var i = 0; i < _instancesCount; ++i)
//        {
//            drawCommands->visibleInstances[i] = i;

//            //// 从传入的 cullingContext 中获取体素的 _objectToWorld 矩阵

//            //// 获取体素的世界位置
//            //Vector3 voxelPosition = ((Matrix4x4)matrices[i]).GetColumn(4); // 获取世界位置 (4x4 矩阵的第4列)

//            //// 使用一个包围盒来表示体素的范围（假设体素大小为1x1x1）
//            //Bounds voxelBounds = new Bounds(voxelPosition, Vector3.one);

//            //// 检查体素是否在视锥体内
//            //if (GeometryUtility.TestPlanesAABB(frustumPlanes, voxelBounds))
//            //{
//            //    drawCommands->visibleInstances[i] = 1; // 1 表示可见
//            //}
//            //else
//            //{
//            //    drawCommands->visibleInstances[i] = 0; // 0 表示不可见
//            //}
//        }
